				...
				<div class="signIn">
					...
					<div class="wrapperButtonsColumn">
						<div class="wrapperButtonsRow">
							...
							<IButton class="fullWidth" label="регистрация" @onClick="handleSign" />
						</div>
						<IButton class="fullWidth focusClass" label="Войти" @onClick="signIn" />
					</div>
				</div>
				<div class="signUp">
					...
					<div class="wrapperButtonsColumn">
						<div class="wrapperButtonsRow">
							<IButton class="fullWidth" label="вернуться" @onClick="handleSign" />
						</div>
						<IButton
